...
<div class="container py-5">
    <div class="card card-svpl p-4 p-md-5 bg-white border-0 shadow-sm">
        ...
        <div class="text-muted small leading-relaxed">
            ...
            <p>Surya Vistaara Pvt. Ltd. (SVPL) operates as the authorized Corporate Promoter for Dhwajja Solar India Pvt. Ltd. Advisors registered with SVPL are independent clean energy promoters and do not represent full-time employment unless explicitly appointed under contract.</p>
