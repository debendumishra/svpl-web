        ...
        <div class="cover-page">
            <div>
                ...
                <p class="cover-subtitle">
                    ...
                    9-Level Commission Engine Architecture, CR80 ID Card Systems, and Financial Accounting.
                </p>
            </div>
        ...
        <div class="manual-page">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; font-size: 0.95rem;">
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 1: Platform Architecture & Roles</strong>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 4px;">Architecture, Super Admin, BOE, Advisor, Customer logins.</p>
                </div>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 2: Back Office Executive (BOE) SOP</strong>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 4px;">Daily queue scrutiny, 6 core KYC document checks.</p>
                </div>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 3: 10-Stage Customer Solar Pipeline</strong>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 4px;">Lead entry to DISCOM feasibility, loan, install & DBT subsidy.</p>
                </div>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 4: 9-Level Commission Engine Architecture</strong>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 4px;">₹1,500 direct bonus, 9-tier slabs, 5% TDS, and bank payouts.</p>
                </div>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 5: Solar Advisor Network & Onboarding</strong>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 4px;">Registration, ₹2,700 UTR verification, 9-level genealogy tree.</p>
                </div>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 6: CR80 PVC ID Card Generator</strong>
                    <p style="color: #64748b; font-size: 0.85rem; margin-top: 4px;">Golden standard dimensions, photo compression & QR code scan.</p>
                </div>
                <div style="background: #f8fafc; padding: 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <strong style="color: #0f2d59;">Chapter 7: Company Double-Entry Ledger</strong>
        ...
        <div class="manual-page">
            <div class="chapter-header">
                <div>
                    ...
                    <h2 class="chapter-title">9-Level Commission Engine Architecture</h2>
                </div>
            </div>

            <p style="margin-bottom: 16px;">
                The platform features an automated <strong>9-Level Commissioning Engine</strong> (<code>CommissionEngine.php</code>) that distributes financial rewards across the sponsor hierarchy whenever a customer project achieves key milestones:
            </p>
            ...
            <table class="manual-table">
                <thead>
                    <tr>
                        ...
                        <th>Advisor Role in Tree</th>
                        <th>Base Commission</th>
                        <th>Direct Customer Bonus</th>
                        <th>Gross Payout</th>
                        <th>TDS (5% 194H)</th>
                        <th>Net Wallet Credit</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="background: #f0fdf4;">
                        <td><strong>Level 1 (Direct)</strong></td>
                        <td>Direct Sponsoring Advisor</td>
                        <td>₹1,000.00</td>
                        <td>₹500.00</td>
                        <td><strong>₹1,500.00</strong></td>
                        <td>₹75.00</td>
                        <td><strong style="color: #166534;">₹1,425.00</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Level 2</strong></td>
                        <td>Direct Mentor / Sponsor</td>
                        <td>₹500.00</td>
                        <td>—</td>
                        <td><strong>₹500.00</strong></td>
                        <td>₹25.00</td>
                        <td><strong style="color: #0369a1;">₹475.00</strong></td>
                    </tr>
                    <tr>
                        ...
                        <td>₹15.00</td>
                        <td><strong style="color: #0369a1;">₹285.00</strong></td>
                    </tr>
                    <tr>
                        ...
                        <td>₹10.00</td>
                        <td><strong style="color: #0369a1;">₹190.00</strong></td>
                    </tr>
                    <tr>
                        <td><strong>Levels 5 to 9</strong></td>
                        <td>Regional & District Uplines</td>
                        <td>₹100.00 each</td>
                        <td>—</td>
                        <td><strong>₹100.00 each</strong></td>
                        <td>₹5.00</td>
                        <td><strong style="color: #0369a1;">₹95.00 each</strong></td>
                    </tr>
                </tbody>
            </table>

            <div class="callout-box callout-info">
                <strong><i class="bi bi-gear-fill me-1"></i> Commission Engine Rules & Bank Payouts:</strong>
                <ul style="margin: 6px 0 0 16px; font-size: 0.9rem;">
                    <li><strong>Trigger Milestones:</strong> Automatic execution occurs when a lead reaches <code>Stage 7: INSTALLATION_COMPLETED</code> or <code>Stage 10: SUBSIDY_RECEIVED</code>.</li>
                    <li><strong>Instant Wallet Credit:</strong> Net earnings are immediately available in the Advisor Digital Wallet (<code>/advisor/wallet</code>).</li>
                    <li><strong>Bank Withdrawal Workflow:</strong> Advisors submit withdrawal requests with their bank IFSC/Account; Admins approve with bank UTR in <code>/admin/withdrawals</code>.</li>
                    <li><strong>Configurable Settings:</strong> Admins can adjust the Direct Bonus, TDS percentage, and Onboarding fees in <code>/admin/settings</code>.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="manual-page">
            <div class="chapter-header">
                <div>
                    ...
                    <h2 class="chapter-title">Solar Advisor Network & Onboarding</h2>
                </div>
            </div>

            <p style="margin-bottom: 16px;">
                Advisors are the field force driving solar adoption across Odisha. The onboarding process guarantees sponsor protection and fast account activation:
            </p>

            <div class="step-block">
                <div class="step-num">1</div>
                <div class="step-content">
                    <h4>Public Registration with Live Referral Lookup</h4>
                    <p>Applicants sign up at <code>/register-advisor</code>. Entering a Referral Code, Advisor ID, or Phone instantly verifies the sponsor's name, district, and active status.</p>
                </div>
            </div>
            ...
            <div class="step-block">
                <div class="step-num">2</div>
                <div class="step-content">
                    <h4>₹2,700 Onboarding Fee & UTR Entry</h4>
                    <p>Advisors transfer the ₹2,700 fee to the official SVPL Bank Account or UPI and enter the transaction UTR number. The account is created in <code>PENDING_APPROVAL</code> status.</p>
                </div>
            </div>
            ...
            <div class="step-block">
                <div class="step-num">3</div>
                <div class="step-content">
                    <h4>Admin Approval & 9-Level Tree Placement</h4>
                    <p>Accounts team confirms the UTR in <code>/admin/payments</code>. The advisor is immediately inserted into the 9-level genealogy closure table, wallet is initialized, and ID card is generated.</p>
                </div>
            </div>
        </div>
