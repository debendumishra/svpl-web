...
<head>
    ...
    <title>Official Solar Advisor ID Card - <?= $advisorCode ?> - <?= htmlspecialchars($fullName) ?></title>
...
<body>
    ...
    <div class="no-print-bar">
        <div>
            <div style="font-weight: 800; color: #0f2d59; font-size: 1.05rem;">Surya Vistaara / Dhwajja Solar — Official Advisor ID Card</div>
        ...
        <div class="card-column">
            <div class="id-card">
                ...
                <div style="padding: 4px 14px 2px 14px; flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: space-between; position: relative; z-index: 10;">
                    ...
                    <!-- 3. Badges Grid: Advisor ID & Blood Group -->
                ...
                <div class="bottom-wave-banner">
                    <svg style="width: 100%; height: 100%; display: block;" preserveAspectRatio="none" viewBox="0 0 320 48">
                        <defs>
                            <linearGradient id="advFrontWaveGrad" x1="0%" x2="100%" y1="0%" y2="100%">
                                <stop offset="0%" stop-color="#0284c7"/>
                                <stop offset="45%" stop-color="#0f2d59"/>
                                <stop offset="78%" stop-color="#1e3a8a"/>
                                <stop offset="100%" stop-color="#0d9488"/>
                            </linearGradient>
                            <linearGradient id="advFrontGoldPinstripe" x1="0%" x2="100%" y1="0%" y2="0%">
                                <stop offset="0%" stop-color="#38bdf8"/>
                                <stop offset="50%" stop-color="#f59e0b"/>
                                <stop offset="100%" stop-color="#fde047"/>
                            </linearGradient>
                        </defs>
                        <path d="M0,19 C65,6 135,15 200,23 C245,28.5 285,24 320,12 L320,48 L0,48 Z" fill="url(#advFrontWaveGrad)"/>
                        <path d="M0,19 C65,6 135,15 200,23 C245,28.5 285,24 320,12" fill="none" stroke="url(#advFrontGoldPinstripe)" stroke-linecap="round" stroke-width="2.5"/>
                    </svg>
                </div>
            </div>
        </div>
        ...
        <div class="card-column">
            <div class="id-card">
                ...
                <div class="bottom-wave-banner">
                    <svg style="width: 100%; height: 100%; display: block;" preserveAspectRatio="none" viewBox="0 0 320 48">
                        <defs>
                            <linearGradient id="advBackWaveGrad" x1="0%" x2="100%" y1="0%" y2="100%">
                                <stop offset="0%" stop-color="#0284c7"/>
                                <stop offset="45%" stop-color="#0f2d59"/>
                                <stop offset="78%" stop-color="#1e3a8a"/>
                                <stop offset="100%" stop-color="#0d9488"/>
                            </linearGradient>
                            <linearGradient id="advBackGoldPinstripe" x1="0%" x2="100%" y1="0%" y2="0%">
                                <stop offset="0%" stop-color="#38bdf8"/>
                                <stop offset="50%" stop-color="#f59e0b"/>
                                <stop offset="100%" stop-color="#fde047"/>
                            </linearGradient>
                        </defs>
                        <path d="M0,19 C65,6 135,15 200,23 C245,28.5 285,24 320,12 L320,48 L0,48 Z" fill="url(#advBackWaveGrad)"/>
                        <path d="M0,19 C65,6 135,15 200,23 C245,28.5 285,24 320,12" fill="none" stroke="url(#advBackGoldPinstripe)" stroke-linecap="round" stroke-width="2.5"/>
                    </svg>
                </div>
            </div>
        </div>
