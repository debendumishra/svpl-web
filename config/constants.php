...
// Load .env file if present (ignored by git for local configurations)
...
// Lead Pipeline Stages (15 standard milestone points)
...
define('LEAD_STAGE_INSTRUMENT_DESPATCHED', 'INSTRUMENT_DESPATCHED');
...
define('LEAD_STAGE_NET_METER', 'NET_METER');
define('LEAD_STAGE_INTIMATION_TO_MMG', 'INTIMATION_TO_MMG');
define('LEAD_STAGE_MMG_METER_REPORT', 'MMG_METER_REPORT');
define('LEAD_STAGE_BANK_SECOND_INSTALLMENT', 'BANK_SECOND_INSTALLMENT');
...
define('LEAD_STATUS_INSTRUMENT_DESPATCHED', 'Instrument Despatched');
...
define('LEAD_STATUS_NET_METER_INSTALLED', 'Net Meter Installed');
define('LEAD_STATUS_MMG_INTIMATED', 'Intimated to MMG');
define('LEAD_STATUS_MMG_REPORT_COMPLETED', 'MMG Meter Change Report Completed');
define('LEAD_STATUS_BANK_SECOND_DISBURSED', 'Bank Second Installment Released');
